...
{/fbvFormSection}
{fbvFormSection list="true" label="plugins.generic.plagiarism.genre.ithenticate"}
	{fbvElement type="checkbox" id="ithenticateAutoDeposit" name="ithenticateAutoDeposit" value=1 checked=$ithenticateAutoDeposit label="plugins.generic.plagiarism.genre.ithenticate.autoDeposit" translate=true}
{/fbvFormSection}
{/fbvFormArea}
